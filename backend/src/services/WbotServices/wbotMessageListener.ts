...
// import GetContactService from "../ContactServices/GetContactService"; // Commented out as it's not used
...
const prepareLocation = (msg: WbotMessage): WbotMessage => {
  ...
  // @ts-ignore
  const locationDescription = msg.location.description
    ? msg.location.description
    : `${msg.location.latitude}, ${msg.location.longitude}`;
  msg.body += `|${locationDescription}`;
